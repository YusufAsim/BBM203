...
public:
    ...
    // reference for bullets
    CelestialObject *bullet_head = nullptr;

    bool CollisionDetect(CelestialObject *obj, Player *player);

    void shootingUpdate(CelestialObject *head_of_projectiles, CelestialObject *obj);
};
